...
impl dyn Any + Leak {
    ...
    /// use std::any::Any;
    ///
    /// fn print_if_string(s: &(dyn Any + Leak)) {
    ///     if let Some(string) = s.downcast_ref::<String>() {
    ///         println!("It's a string({}): '{}'", string.len(), string);
    ///     } else {
    ///         println!("Not a string...");
    ...
    /// use std::any::Any;
    ///
    /// fn modify_if_u32(s: &mut (dyn Any + Leak)) {
    ///     if let Some(num) = s.downcast_mut::<u32>() {
    ///         *num = 42;
    ///     }
    /// }
...
impl dyn Any + Send + Sync + Leak {
    ...
    /// use std::any::Any;
    ///
    /// fn is_string(s: &(dyn Any + Send + Sync + Leak)) {
    ///     if s.is::<String>() {
    ///         println!("It's a string!");
    ///     } else {
    ///         println!("Not a string...");
    ...
    /// use std::any::Any;
    ///
    /// fn print_if_string(s: &(dyn Any + Send + Sync + Leak)) {
    ///     if let Some(string) = s.downcast_ref::<String>() {
    ///         println!("It's a string({}): '{}'", string.len(), string);
    ///     } else {
    ///         println!("Not a string...");
    ...
    /// use std::any::Any;
    ///
    /// fn modify_if_u32(s: &mut (dyn Any + Send + Sync + Leak)) {
    ///     if let Some(num) = s.downcast_mut::<u32>() {
    ///         *num = 42;
    ///     }
    /// }
